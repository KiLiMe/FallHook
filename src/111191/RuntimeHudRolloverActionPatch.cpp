// AI CONTEXT: Applies the 1.11.191 HUDRollover action replacement path.
// Depends on activation/PERK destination maps, activation look context, catalog provider, and memory safety helpers.
// Runtime scope is Fallout 4 1.11.191 HUDRollover trap/furniture/robot action slots only.
