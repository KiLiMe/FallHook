// AI CONTEXT: Hooks player dialogue context and DialogueMenuUtils button text for 1.11.191 choices.
// Depends on RuntimeDialogueChoiceTranslations, RuntimeHookWatch, and RuntimePrologueHook.
// Runtime scope is Fallout 4 1.11.191 player dialogue menu buttons only.
// Version-specific logic: installs 1.11.191 hooks at Address Library IDs 2196825 (GetCurrentTopicInfo) and 2249662 (SetButtonText).
