...
// Runtime scope is Fallout 4 1.11.191 RACE:FMRN, RACE:MPPN, and RACE:TTGP data.
// Version-specific logic: Fallout 4 1.11.191 TESRace::faceRelatedData layout and xEdit flat REC ordering.
