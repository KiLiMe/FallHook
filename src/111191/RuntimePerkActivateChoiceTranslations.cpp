...
// Depends on TranslationCatalog records, RuntimeApplySettings, and SourceFreeTranslationKeys.
// Runtime scope is Fallout 4 1.11.191 perk entry-point activate-choice data for HUDRollover.
// Version-specific logic: none; HUDRollover owns runtime hook addresses.
// Source-free policy: stores destination text keyed by editorID target map plus RoboticsExpert special text, never by Source text.
#include "PCH.h"
