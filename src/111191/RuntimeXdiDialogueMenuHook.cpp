// AI CONTEXT: Wraps XDI DialogueMenu GetDialogueOptions for 1.11.191 source-free option text replacement.
// Depends on F4SE Scaleform callbacks, RuntimeXdiDialogueOptionTranslations, RuntimeHookWatch, and RuntimePrologueHook.
// Runtime scope is Fallout 4 1.11.191 DialogueMenu.swf only; XDI is optional and detected at runtime.
// Version-specific logic: installs 1.11.191 GFx Value::ObjectInterface hooks using provided Address Library IDs.
...
#include "111191/RuntimeXdiDialogueOptionResolver.h"
#include "111191/RuntimeXdiScaleformAccess.h"
