...
// Runtime scope is Fallout 4 1.11.191 dialogue response resolver support.
// Version-specific logic: consumes 111191 candidate lists but contains no hook addresses.
