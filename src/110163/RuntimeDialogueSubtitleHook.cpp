...
// Runtime scope is Fallout 4 1.10.163 only; uses verified Address Library ID 875508.
// Version-specific logic: installs a 1.10.163 prologue hook at SubtitleManager::ShowSubtitle.
...
namespace
{
	...
	constexpr REL::ID kShowSubtitleID{ 875508 };
