// AI CONTEXT: Implements the shared 1.10.163 dialogue choice context cache.
// Depends on RuntimeDialogueChoiceTranslations and CommonLibF4 TESTopic/TESTopicInfo layout.
// Runtime scope is Fallout 4 1.10.163 dialogue hooks that need source-free INFO/DIAL identity.
// Version-specific logic: follows TESTopicInfo::dataInfo chains captured by the 1.10.163 dialogue hook.
