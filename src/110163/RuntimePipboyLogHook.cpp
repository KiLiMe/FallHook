...
// Depends on RuntimePipboyLogTranslations, RuntimeHookWatch, and the 1.10.163 PopulateStatsVisitor vtable.
// Runtime scope is Fallout 4 1.10.163 PipboyLogData::PopulateStatsVisitor only.
