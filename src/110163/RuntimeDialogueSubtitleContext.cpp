...
// Runtime scope is Fallout 4 1.10.163 response construction followed by subtitle display.
// Version-specific logic: keys by 1.10.163 INFO form ID, speaker form ID, and pooled raw response pointer.
