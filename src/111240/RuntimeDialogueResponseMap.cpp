...
// Runtime scope is Fallout 4 1.11.240 dialogue response resolver support.
// Version-specific logic: consumes 111240 candidate lists but contains no hook addresses.
// Source-free policy: never reads Source or visible text; only stable response identity keys are used.
#include "PCH.h"

#include "111240/RuntimeDialogueResponseMap.h"
