...
// Runtime scope is Fallout 4 1.11.240 response construction followed by subtitle display.
// Version-specific logic: keys by 1.11.240 INFO form ID, speaker form ID, and pooled raw response pointer.
