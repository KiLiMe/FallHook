...
// Runtime scope is Fallout 4 1.11.240 dialogue choice prompt rendering.
// Version-specific logic: resolves 1.11.240 runtime form IDs from plugin/raw XML identity.
