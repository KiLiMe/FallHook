...
// Runtime scope is Fallout 4 1.11.240 QUST:CNAM quest journal string/stage/item identity maps only.
// Version-specific logic: caches the 1.11.240 GetLogEntry identity tuple.
