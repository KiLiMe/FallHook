// AI CONTEXT: Hooks player dialogue context and DialogueMenuUtils button text for 1.11.240 choices.
// Depends on RuntimeDialogueChoiceTranslations, RuntimeHookWatch, and RuntimePrologueHook.
// Runtime scope is Fallout 4 1.11.240 player dialogue menu buttons only.
// Version-specific logic: installs 1.11.240 hooks at Address Library IDs 2196825 (GetCurrentTopicInfo) and 2249662 (SetButtonText).
...
#include "111240/RuntimeDialogueChoiceContext.h"
...
namespace
{
	...
	constexpr REL::ID kGetCurrentTopicInfoID{ 2196825 };
	constexpr REL::ID kSetButtonTextID{ 2249662 }; // RVA 0x1083A10, user-confirmed via owner trace
