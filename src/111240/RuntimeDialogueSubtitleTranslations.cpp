// AI CONTEXT: Builds and resolves INFO:NAM1 subtitle fallback maps for 1.11.240.
// Depends on RuntimeFormResolver, RuntimeLocalizedStringID, response candidates, and TranslationCatalog.
// Runtime scope is Fallout 4 1.11.240 subtitle display paths with TESTopicInfo identity available.
// Version-specific logic: uses 111240 form resolution and TESTopicInfo candidate traversal.
