...
// Runtime scope is Fallout 4 1.11.240 BSScaleformTranslator AddTranslations input only.
// Version-specific logic: none; hook modules own 1.11.240 relocation IDs.
...
namespace Runtime111240::RuntimeInGameTextScaleformStream
{
