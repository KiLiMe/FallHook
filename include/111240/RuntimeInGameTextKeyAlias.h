// AI CONTEXT: Caches 1.11.240 UI key-to-literal aliases for global in-game UI text.
// Depends on RuntimeInGameTextDictionary and standard library collections.
// Runtime scope is Fallout 4 1.11.240 in-game UI text translation only.
...
namespace Runtime111240::RuntimeInGameTextKeyAlias
{
	namespace detail
	{
