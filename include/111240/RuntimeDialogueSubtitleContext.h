...
// Runtime scope is Fallout 4 1.11.240 dialogue response construction and subtitle handoff.
// Version-specific logic: uses 1.11.240 TESTopicInfo form identity and pooled BSFixedString pointers.
...
namespace Runtime111240::RuntimeDialogueSubtitleContext
{
	struct LookupResult
	{
