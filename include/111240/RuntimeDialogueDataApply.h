...
// Runtime scope is Fallout 4 1.11.240 dialogue data mutation during catalog apply only.
// Version-specific logic: applies 1.11.240 DIAL:FULL records.
...
namespace Runtime111240::RuntimeDialogueDataApply
{
	struct ApplyStats
	{
