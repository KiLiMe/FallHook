// AI CONTEXT: Resolves TESFullName component owners for the 1.11.240 FULL load hook.
// Depends on CommonLibF4 form layouts and Windows page metadata for cached readability checks.
// Runtime scope is Fallout 4 1.11.240 only; offsets are verified for this runtime's loaded form layouts.
// Version-specific logic: owns TESFullName component offsets for WEAP/ARMO/MISC/OMOD/NPC_ in 1.11.240.
...
namespace Runtime111240::RuntimeFullNameOwnerResolver
{
	struct CacheStats
	{
