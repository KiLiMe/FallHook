// AI CONTEXT: Scaleform GFx::Value raw access helpers shared by the 1.11.240 XDI DialogueMenu hook.
// Depends on Scaleform GFx_Value.h ObjectInterface layout and CommonLibF4 REX enum helpers.
// Runtime scope is Fallout 4 1.11.240 XDI DialogueMenu.swf Value introspection only.
// Version-specific logic: reads Scaleform::GFx::Value internals via ValueAccess union; assumes 1.11.240 layout.
...
namespace Runtime111240::RuntimeXdiScaleformAccess
{
