// AI CONTEXT: Stores source-free INFO:NAM1 subtitle fallback text for 1.11.240.
// Depends on TranslationCatalog and CommonLibF4 fixed strings/topic-info declarations.
// Runtime scope is Fallout 4 1.11.240 subtitle text before HUD subtitle display.
// Version-specific logic: resolves 1.11.240 INFO form IDs during Rebuild.
...
namespace Runtime111240::RuntimeDialogueSubtitleTranslations
{
	struct LookupResult
	{
