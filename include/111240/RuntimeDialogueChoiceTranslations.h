// AI CONTEXT: Stores source-free dialogue choice prompt lookup data for 1.11.240 button hooks.
// Depends on TranslationCatalog and fixed-size form identity context structs.
// Runtime scope is Fallout 4 1.11.240 INFO:RNAM and DIAL:FULL dialogue choice lookup.
// Version-specific logic: uses 111240 form resolution during Rebuild.
...
namespace Runtime111240::RuntimeDialogueChoiceTranslations
{
