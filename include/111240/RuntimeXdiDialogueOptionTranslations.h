// AI CONTEXT: Stores 1.11.240 XDI dialogue option text by source-free INFO identity.
// Depends on TranslationCatalog records and 1.11.240 runtime form resolution.
// Runtime scope is XDI DialogueMenu prompt/response replacement only.
// Version-specific logic: resolves 1.11.240 runtime INFO form IDs from XML/plugin identity.
...
namespace Runtime111240::RuntimeXdiDialogueOptionTranslations
{
	struct OptionText
	{
		std::string prompt;
