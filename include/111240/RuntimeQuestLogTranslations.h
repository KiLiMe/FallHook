...
// Runtime scope is Fallout 4 1.11.240 quest journal string/stage/item identity maps only.
// Version-specific logic: lookup accepts the 1.11.240 TESQuestStageItem identity shape.
...
namespace Runtime111240::RuntimeQuestLogTranslations
{
