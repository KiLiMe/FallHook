// AI CONTEXT: Collects source-free dialogue response candidate INFO owners for 1.11.240.
// Depends on CommonLibF4 TESTopic/TESTopicInfo/TESResponse layout only.
// Runtime scope is Fallout 4 1.11.240 DialogueResponse construction cache misses.
// Version-specific logic: reads 1.11.240 topic info arrays and response linked lists.
...
namespace Runtime111240::RuntimeDialogueResponseCandidates
{
