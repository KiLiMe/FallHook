...
// Runtime scope is Fallout 4 1.11.240 reference/base identity capture.
// Version-specific logic: fixed 1.11.240 Address Library ID 2201128 only.
// Source-free policy: captures form and editorID identity; displayed text is diagnostic only.
#pragma once

namespace Runtime111240::RuntimeActivationContextHook
{
	void Install();
}
