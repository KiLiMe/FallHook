...
// Depends on ConstApplyMap, RuntimeApplySettings, and 1.11.240 runtime text writers.
// Runtime scope is Fallout 4 1.11.240 direct const text mutation only.
...
namespace Runtime111240::RuntimeConstApplyCache
{
	struct ApplyStats
	{
