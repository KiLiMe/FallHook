...
// Runtime scope is Fallout 4 1.10.163 dialogue response construction and subtitle handoff.
// Version-specific logic: uses 1.10.163 TESTopicInfo form identity and pooled BSFixedString pointers.
