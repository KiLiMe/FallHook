...
// Depends on TranslationCatalog target text, CommonLibF4 fixed strings, and 110163 response candidates.
// Runtime scope is Fallout 4 1.10.163 dialogue response identity lookup.
// Version-specific logic: uses 110163 TESTopicInfo candidate identity supplied by the owning runtime module.
