// AI CONTEXT: Exposes the Fallout 4 1.10.163 runtime module to the dispatcher.
// Depends on the version-neutral RuntimeVersionDispatcher module contract.
// Runtime assumptions: owns Fallout 4 runtime 1.10.163 only.
// Version-specific logic: yes; implementation installs only 1.10.163 hooks and data mutation paths.
