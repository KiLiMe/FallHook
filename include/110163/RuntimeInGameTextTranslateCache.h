// AI CONTEXT: Caches 1.10.163 literal TXT lookups for BSScaleformTranslator::Translate.
// Depends on RuntimeInGameTextDictionary for normalized source-keyed TXT lookup and revision tracking.
// Runtime scope is Fallout 4 1.10.163 InGameText Translate hook hot path only.
// Version-specific logic: none beyond owning 110163 hook cache state; no offsets or hook sites here.
...
namespace RuntimeInGameTextTranslateCache
{
	namespace detail
	{
