...
// Depends on ConstApplyMap, RuntimeApplySettings, and 1.11.191 runtime text writers.
// Runtime scope is Fallout 4 1.11.191 direct const text mutation only.
...
namespace Runtime111191::RuntimeConstApplyCache
{
	struct ApplyStats
	{
