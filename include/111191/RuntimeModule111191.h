// AI CONTEXT: Exposes the Fallout 4 1.11.191 runtime module to the dispatcher.
// Depends on the version-neutral RuntimeVersionDispatcher module contract.
// Runtime assumptions: owns Fallout 4 runtime 1.11.191 only.
// Version-specific logic: yes; implementation installs only 1.11.191 hooks and data mutation paths.
...
namespace Runtime111191::RuntimeModule111191
{
