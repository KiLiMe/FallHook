...
// Runtime scope is Fallout 4 1.11.191 direct RACE data mutation only.
// Version-specific logic: Fallout 4 1.11.191 TESRace layout and nested container order.
...
namespace Runtime111191::RuntimeRaceText
{
