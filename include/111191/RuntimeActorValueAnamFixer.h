...
// Runtime scope is Fallout 4 1.11.191 AVIF abbreviation data.
// Version-specific logic: Fallout 4 1.11.191 AVIF ANAM offset 0x1A0.
...
namespace Runtime111191::RuntimeActorValueAnamFixer
{
