// AI CONTEXT: Resolves XDI dialogue option IDs to 1.11.191 TESTopicInfo identities.
// Depends on CommonLibF4 dialogue scene/topic layouts through the plugin target.
// Runtime scope is Fallout 4 1.11.191 XDI DialogueMenu option resolution only.
// Version-specific logic: mirrors 1.11.191 active XDI dialogue-map topic ordering.
...
namespace Runtime111191::RuntimeXdiDialogueInfoResolver
{
