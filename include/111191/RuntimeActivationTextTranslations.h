...
// Runtime scope is Fallout 4 1.11.191 ACTI/FLOR/FURN/NPC_ activation prompt records.
// Version-specific logic: 1.11.191 HUDRollover action patch lookup data only.
...
namespace Runtime111191::RuntimeActivationTextTranslations
{
	struct RebuildStats
	{
