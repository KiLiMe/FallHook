...
// Depends on TranslationCatalog, CommonLibF4 dialogue response identity, and 1.11.191 form resolution.
// Runtime scope is Fallout 4 1.11.191 response construction before subtitle-context capture.
