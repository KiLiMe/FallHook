...
// Runtime scope is Fallout 4 1.11.191 BSScaleformTranslator AddTranslations input only.
// Version-specific logic: none; hook modules own 1.11.191 relocation IDs.
...
namespace Runtime111191::RuntimeInGameTextScaleformStream
{
