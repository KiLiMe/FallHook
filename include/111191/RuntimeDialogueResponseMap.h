...
// Depends on TranslationCatalog target text, CommonLibF4 fixed strings, and 111191 response candidates.
// Runtime scope is Fallout 4 1.11.191 dialogue response identity lookup.
// Version-specific logic: uses 111191 TESTopicInfo candidate identity supplied by the owning runtime module.
...
namespace Runtime111191::RuntimeDialogueResponseMap
{
	struct Target
	{
		std::string text;
