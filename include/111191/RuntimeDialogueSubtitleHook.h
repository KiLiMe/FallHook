// AI CONTEXT: Declares the 1.11.191 SubtitleManager::ShowSubtitle identity fallback hook.
...
// Version-specific logic: implementation owns verified 1.11.191 Address Library ID 2249542.
// Source-free policy: hook delegates to INFO form/sID lookup; it never matches visible/source text.
#pragma once

namespace Runtime111191::RuntimeDialogueSubtitleHook
{
	void Install();
}
