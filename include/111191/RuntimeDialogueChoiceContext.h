// AI CONTEXT: Shares captured 1.11.191 dialogue choice identities between button and XDI hooks.
// Depends on RuntimeDialogueChoiceTranslations for the source-free form identity payload.
// Runtime scope is Fallout 4 1.11.191 player dialogue choices only.
// Version-specific logic: stores TESTopicInfo pointers captured from the verified 1.11.191 dialogue hook.
...
namespace Runtime111191::RuntimeDialogueChoiceContext
{
