// AI CONTEXT: Caches 1.11.191 literal TXT lookups for BSScaleformTranslator::Translate.
// Depends on RuntimeInGameTextDictionary for normalized source-keyed TXT lookup and revision tracking.
// Runtime scope is Fallout 4 1.11.191 InGameText Translate hook hot path only.
// Version-specific logic: none beyond owning 111191 hook cache state; no offsets or hook sites here.
...
namespace Runtime111191::RuntimeInGameTextTranslateCache
{
	namespace detail
	{
